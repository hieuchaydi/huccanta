...
4. **Python:** đã dùng resolver AST mới cho class owner, `self`, ambiguity và branch types riêng;
   import/alias xuyên module vẫn là giới hạn công khai, chưa được tuyên bố là đã resolve.
